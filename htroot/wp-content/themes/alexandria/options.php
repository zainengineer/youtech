...
function optionsframework_options() {
	...
	$options[] = array( "name" => "country1",
		...
		$options[] = array( "name" => __("Select a Skin", 'alexandria' ),
				...
				$options[] = array( "name" => __("Select a Skin", 'alexandria' ),
										"desc" => __("Images for skins.", 'alexandria' ),
										"id" => "skin_style",
										"type" => "images",
										"std" => "alexandria",
										"options" => array(
		...
		$options[] = array( "name" => __("Single Page Settings", 'alexandria' ),
					...
					$options[] = array( "name" => __("Show Featured Image?", 'alexandria' ),
										"desc" => __("Select yes if you want to show featured image as header.", 'alexandria' ),
	...
	$options[] = array( "name" => "country10",
		...
		$options[] = array( "name" => __("Logo Section Layout Settings", 'alexandria' ),
							"type" => "tabheading");		
	...
	$options[] = array( "name" => "country3",
		...
		$options[] = array( "name" => __("Select Header Type", 'alexandria' ),
					...
					$options[] = array( "name" => __("Select a Header or Slider", 'alexandria' ),
										"desc" => __("Images for slider.", 'alexandria' ),
										"id" => "header_slider",
										"std" => "one",
										"type" => "images",
										"std" => "one",
		...
		$options[] = array( "name" => __("Slider Settings", 'alexandria' ),
							"type" => "groupcontaineropen");	

					
					$options[] = array( "name" => __("Show slider on homepage", 'alexandria' ),
										"desc" => __("Select yes if you want to show slider on homepage.", 'alexandria' ),
					...
					$options[] = array( "name" => __("Show slider on Single post page", 'alexandria' ),
										"desc" => __("Select yes if you want to show slider on Single post page.", 'alexandria' ),
					...
					$options[] = array( "name" => __("Show slider on Pages", 'alexandria' ),
										"desc" => __("Select yes if you want to show slider on Pages.", 'alexandria' ),
					...
					$options[] = array( "name" => __("Show slider on Category Pages", 'alexandria' ),
										"desc" => __("Select yes if you want to show slider on Category Pages.", 'alexandria' ),
