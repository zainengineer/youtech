...
function alexandria_add_stylesheets( ) {
	...
	if( !is_admin() ) {
								...
								wp_enqueue_style('alexandria_dropdowncss', get_stylesheet_directory_uri().'/css/dropdown.css');
								wp_enqueue_style('alexandria_rtldropdown', get_stylesheet_directory_uri().'/css/dropdown.vertical.rtl.css');
								wp_enqueue_style('alexandria_advanced_dropdown', get_stylesheet_directory_uri().'/css/default.advanced.css');
...
<![endif]--> ';
								...
								if( of_get_option('skin_style') == 'alexandria' ) {
									wp_enqueue_style('alexandria_alexandriastyle', get_template_directory_uri().'/skins/alexandria.css');	
								}elseif( of_get_option('skin_style') == 'radi' ) {
									wp_enqueue_style('alexandria_silvstyle', get_template_directory_uri().'/skins/radi.css');
								}else {
									wp_enqueue_style('alexandria_Defaultstyle', get_stylesheet_directory_uri().'/lite.css');
								}									
